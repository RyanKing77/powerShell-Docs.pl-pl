...
Polecenie cmdlet Publish-skryptu publikuje określony skrypt do galerii online.

## <a name="description"></a>Opis

Polecenia cmdlet publikowania skryptu umożliwia opublikowany plik skryptu prawidłowe metadane, takie jak wersja, Guid, autora i opis, itp. Parametr przełącznika Wymuś na temat polecenia cmdlet Publish-skryptu używa do ładowania NuGet.exe bez monitowania.
