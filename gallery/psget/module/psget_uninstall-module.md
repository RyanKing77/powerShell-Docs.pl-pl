...
---
# <a name="uninstall-module"></a>Odinstaluj moduł

Odinstalowuje moduł, który został zainstalowany przy użyciu poleceń cmdlet PowerShellGet.

## <a name="description"></a>Opis

Polecenia cmdlet Uninstall-Module Odinstalowuje określony moduł z komputera lokalnego. Nie można odinstalować moduł, jeśli niektóre inne moduły mają zależność od niej.
