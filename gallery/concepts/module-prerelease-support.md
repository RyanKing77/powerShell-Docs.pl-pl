...
<span data-ttu-id="bb5c8-125">Szczegółowe wymagania wstępne ciągu są następujące:</span><span class="sxs-lookup"><span data-stu-id="bb5c8-125">The detailed requirements for Prerelease string are:</span></span>
