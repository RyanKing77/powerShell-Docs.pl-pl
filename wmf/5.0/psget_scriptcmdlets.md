...
---
# <a name="powershellget-cmdlets-for-script-management"></a>Polecenia cmdlet PowerShellGet zarządzania skryptu
...
## <a name="uninstall-script-cmdlet"></a>Polecenia cmdlet odinstalować skryptu
```powershell
