...
---
# <a name="installation-of-module-dependencies"></a>Instalacja zależności modułów
...
**Zainstaluj moduł przy użyciu zależności:**
```powershell
PS C:\windows\system32> Get-InstalledModule
...
**Zawartość modułu ModuleWithDependencies2 plik manifestu:**
```powershell
@{
