...
---
# <a name="new-built-in-dsc-resources"></a>Nowe wbudowane zasoby DSC

WMF 5.0 RTM ma 4 nowych zasobów DSC: 
* WindowsFeatureSet
* WindowsOptionalFeatureSet
* ServiceSet
* ProcessSet 

Te zasoby umożliwiają łatwe do skonfigurowania kilku wystąpień przy użyciu wywołania pojedynczy zasób.
