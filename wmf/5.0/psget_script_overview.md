...
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="30bc2-102">Odnajdywania skryptu PowerShell, instalacja i zarządzanie za pomocą PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="30bc2-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="30bc2-103">Skrypt programu PowerShell udostępniania funkcji zostały dodane do PowerShellGet w wersji RTM programu WMF 5.0.</span><span class="sxs-lookup"><span data-stu-id="30bc2-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="30bc2-104">Następujące nowe polecenia cmdlet są dodawane do modułu PowerShellGet do obsługi skryptów programu PowerShell.</span><span class="sxs-lookup"><span data-stu-id="30bc2-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="30bc2-105">Składnia skryptu udostępnianie poleceń cmdlet:</span><span class="sxs-lookup"><span data-stu-id="30bc2-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
