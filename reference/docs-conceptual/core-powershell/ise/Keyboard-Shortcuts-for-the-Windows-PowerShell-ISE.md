...
ms.locfileid: "30953824"
---
# <a name="keyboard-shortcuts-for-the-windows-powershell-ise"></a>Skróty klawiaturowe w środowisku Windows PowerShell ISE

Użyj następujących skrótów klawiaturowych w celu wykonania akcji w systemie Windows PowerShell® Integrated Scripting Environment (ISE). Windows PowerShell ISE jest dostępna jako część systemu Windows Server i systemów, ale może także klienta systemu Windows można zainstalować na niektóre starsze systemy operacyjne Windows w ramach [pakiet Windows Management Framework 4.0 do pobrania](http://go.microsoft.com/fwlink/?LinkID=293881).
...
|----------|----------------------|----------|
|**Pomoc**|F1|Okienko skryptu **ważne:** można określić, czy Pomoc F1 pochodzą z biblioteki TechNet w sieci web lub pobierane pomocy (zobacz Update-Help). Aby wybrać, kliknij przycisk **narzędzia**, **opcje**, a następnie w **ustawienia ogólne**karcie, ustawiania i czyszczenia **Użyj lokalnej zawartości pomocy zamiast zawartości online.**|
|**Kopiuj**|CTRL+C|W okienku danych wyjściowych skryptu, okienko poleceń|
|**Cut**|CTRL+X|Skrypt, okienko poleceń|
|**Rozwiń lub Zwiń, obramowanie**|CTRL+M|Okienko skryptu|
...
|**Wklej**|CTRL + V|Skrypt, okienko poleceń|
|**Wykonaj ponownie**|CTRL+Y|Skrypt, okienko poleceń|
|**Zastąp w skrypcie**|CTRL+H|Okienko skryptu|
|**Zapisywanie**|CTRL+S|Okienko skryptu|
|**Zaznacz wszystko**|CTRL + A|W okienku danych wyjściowych skryptu, okienko poleceń|
|**Pokaż wstawki kodu programu**|CTRL+J|Skrypt, okienko poleceń|
|**Cofnij**|CTRL+Z|Skrypt, okienko poleceń|
...
|**Karta** (do następnego skryptu)|CTRL + TAB **Uwaga:** Tab do następnego skryptu działa tylko wtedy, gdy masz pojedynczej karcie środowiska Windows PowerShell, Otwórz, lub gdy masz więcej niż jedną kartę środowiska Windows PowerShell, Otwórz, ale skupiono się w okienku skryptów.|
|**Karta** (do poprzedniego skryptu)|CTRL + SHIFT + TAB **Uwaga:** kartę do poprzedniego skryptu działa, jeśli masz tylko jedną Otwórz kartę środowiska Windows PowerShell lub jeśli masz więcej niż jedną kartę środowiska Windows PowerShell, Otwórz, a skupiono się w okienku skryptów.|
...
|Akcja|Skróty klawiaturowe|
|----------|---------------------|
|**Przejdź do polecenia (v2) lub konsoli (w wersji 3 i nowszych) okienko**|CTRL+D|
|**Przejdź do okienka wyjściowego (tylko wersja 2)**|CTRL+SHIFT+O|
...
> [!NOTE]
> Umożliwia także skróty klawiaturowe przeznaczone do konsoli środowiska Windows PowerShell, gdy debugowanie skryptów w środowisku Windows PowerShell ISE. Te skróty używane, należy wpisać skrótu w okienku polecenie i naciśnij klawisz ENTER.
...
|**Poprzedniej karty środowiska PowerShell**|CTRL+SHIFT+TAB. Ten skrót działa tylko wtedy, gdy żadne pliki nie są otwarte na każdej z kart środowiska Windows PowerShell.|
|**Następna karta środowiska Windows PowerShell**|CTRL+TAB. Ten skrót działa tylko wtedy, gdy żadne pliki nie są otwarte na każdej z kart środowiska Windows PowerShell.|
...
- [Magazyn programu PowerShell: Pełna lista programu Windows PowerShell ISE skróty klawiaturowe](http://www.powershellmagazine.com/2013/01/29/the-complete-list-of-powershell-ise-3-0-keyboard-shortcuts/)