...
Naciśnij klawisz **CTRL + H** lub na **Edytuj** menu, kliknij przycisk **Zamień w skrypcie**. Wprowadzić tekst do wyszukania i tekst, z którym chcesz go zastąpić, a następnie naciśnij klawisz **ENTER**.
