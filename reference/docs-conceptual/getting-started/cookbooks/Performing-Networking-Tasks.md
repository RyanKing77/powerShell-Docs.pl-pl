...
---
# <a name="performing-networking-tasks"></a>Wykonywanie zadań sieci
...
Można użyć **filtru** instrukcji "IPEnabled = true i DHCPEnabled = false" w celu uniknięcia włączania DHCP, na którym jest już włączony, ale pominięcie tego kroku nie będą powodować błędy.
