...
---
# <a name="starting-the-windows-powershell-20-engine"></a>Uruchamianie aparat Windows PowerShell 2.0
...
Aby uzyskać więcej informacji na temat zadań w tle, zobacz [about_Jobs [4]](https://docs.microsoft.com/powershell/module/microsoft.powershell.core/about/about_jobs?view=powershell-4.0).
