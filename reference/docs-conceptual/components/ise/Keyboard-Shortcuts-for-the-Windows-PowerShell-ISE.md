...
Do wykonania akcji w Windows PowerShell® zintegrowane Scripting Environment (ISE), należy użyć następujących skrótów klawiaturowych. Windows PowerShell ISE jest dostępny jako część systemu Windows Server i klienta Windows, systemów, ale może również można zainstalować w niektórych starszych systemach operacyjnych Windows w ramach [pakiet Windows Management Framework 4.0 do pobrania](https://go.microsoft.com/fwlink/?LinkID=293881).
...
|----------|----------------------|----------|
|**Pomoc**|F1|W okienku skryptu **ważne:** Można określić, czy F1 Pomoc jest dostępna w bibliotece TechNet w sieci web lub pobierane (zobacz sekcję Update-Help). Aby zaznaczyć, kliknij **narzędzia**, **opcje**, a następnie w **ustawienia ogólne**kartę, ustawić lub wyczyścić **używać lokalnej zawartości pomocy zamiast zawartości w trybie online.**|
|**Kopiuj**|CTRL+C|Skrypt okienko, w okienku poleceń, okienko danych wyjściowych|
|**Cut**|CTRL+X|Skrypt, okienko polecenia|
|**Rozwiń lub Zwiń konspekt**|CTRL+M|Okienko skryptu|
...
|**Wyświetlone fragmenty kodu**|CTRL+J|Skrypt, okienko polecenia|
|**Cofnij**|CTRL+Z|Skrypt, okienko polecenia|
...
|**Karta** (do następnego skryptu)|CTRL + TAB **Uwaga:** TAB, aby dalej skrypt działa tylko wtedy, gdy masz pojedynczej karcie środowiska Windows PowerShell, Otwórz lub w przypadku, gdy masz więcej niż jedną kartę programu Windows PowerShell, Otwórz, ale fokus znajduje się w okienku skryptów.|
|**Karta** (do poprzedniego skryptu)|CTRL + SHIFT + TAB **Uwaga:** TAB, aby poprzedni skrypt działa, jeśli masz tylko jedną kartę programu Windows PowerShell, Otwórz lub jeśli masz więcej niż jedną kartę programu Windows PowerShell, Otwórz, a fokus znajduje się w okienku skryptów.|
...
|**Poprzedniej karty programu PowerShell**|CTRL+SHIFT+TAB. Ten skrót działa tylko wtedy, gdy żadne pliki nie są otwarte na dowolnej karcie środowiska Windows PowerShell.|
|**Następna karta środowiska Windows PowerShell**|CTRL+TAB. Ten skrót działa tylko wtedy, gdy żadne pliki nie są otwarte na dowolnej karcie środowiska Windows PowerShell.|
...
- [Magazyn programu PowerShell: Pełną listę skróty klawiaturowe programu Windows PowerShell ISE](https://www.powershellmagazine.com/2013/01/29/the-complete-list-of-powershell-ise-3-0-keyboard-shortcuts/)
