...
Obsługuje [Ubuntu 14.04][u14], [Ubuntu 16.04][u16], [Ubuntu 18.04][u1804], [Ubuntu 18.10][u1810],  [Debian 9][deb9],
[CentOS 7][cos], [czerwony Hat Enterprise Linux (RHEL) 7][rhel7], [openSUSE 42.3][opensuse], [openSUSE Leap 15][opensuse],
[Fedora 27][fedora], [Fedora 28] [fedora], i [Arch Linux][arch].
...
### <a name="installation---opensuse-leap-15"></a>Instalacja — openSUSE Leap 15
...
### <a name="uninstallation---opensuse-423-opensuse-leap-15"></a>Dezinstalacja - openSUSE 42.3, openSUSE Leap 15
...
Jeśli chcesz zainstalować wersję zapoznawczą, skorzystaj z następujących metod.
...
Po zainstalowaniu przystawki zostanie automatycznie uaktualniona, ale możesz wyzwolić uaktualnienia przy użyciu `sudo snap refresh powershell` lub `sudo snap refresh powershell-preview`.
...
* `$PSHOME` jest `/opt/microsoft/powershell/6.2.0/`
