...
Blok danych konfiguracyjnych definiuje węzły docelowe, których działanie od tego, czy lub nie, aby zaszyfrować poświadczenia, oznacza, że szyfrowania i inne informacje. Aby uzyskać więcej informacji na temat konfiguracji bloku danych, zobacz [oddzielając konfigurację i dane środowiska](configData.md).
