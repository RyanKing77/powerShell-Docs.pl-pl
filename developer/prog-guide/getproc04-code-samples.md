...
---
# <a name="getproc04-code-samples"></a>Przykłady kodu GetProc04

Poniżej przedstawiono przykłady kodu, aby uzyskać przykładowe polecenie cmdlet GetProc04. Jest to `Get-Process` przykładowe polecenia cmdlet opisane w [Dodawanie niekończące raportowania z błędów, do polecenia Cmdlet usługi](../cmdlet/adding-non-terminating-error-reporting-to-your-cmdlet.md). To `Get-Process` wywołania polecenia cmdlet [System.Management.Automation.Cmdlet.Writeerror*](/dotnet/api/System.Management.Automation.Cmdlet.WriteError) zawsze, gdy jest nieprawidłowa operacja jest zwracany wyjątek podczas pobierania informacji o procesie.
...
|Język|Temat|
|--------------|-----------|
|C#|[GetProc04 (C#) przykładowego kodu](./getproc04-csharp-sample-code.md)|
|VB.NET|[GetProc04 kodu przykładowego (VB.NET)](./getproc04-vb-net-sample-code.md)|
