...
ms.locfileid: "62081686"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="9f322-102">Przykładowy kod GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="9f322-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="9f322-103">Oto kompletny Kod VB.NET, aby uzyskać przykładowe polecenie cmdlet GetProc05.</span><span class="sxs-lookup"><span data-stu-id="9f322-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="9f322-104">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="9f322-104">See Also</span></span>

[<span data-ttu-id="9f322-105">Zestaw SDK programu Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="9f322-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)