...
ms.locfileid: "58056417"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="192ac-102">Przykładowy kod GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="192ac-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="192ac-103">Oto kompletny Kod VB.NET, aby uzyskać przykładowe polecenie cmdlet GetProc05.</span><span class="sxs-lookup"><span data-stu-id="192ac-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="192ac-104">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="192ac-104">See Also</span></span>

[<span data-ttu-id="192ac-105">Zestaw SDK programu Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="192ac-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)