---
title: GetProc05 kodu przykładowego (VB.NET) | Dokumentacja firmy Microsoft
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56845066"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="220a3-102">Przykładowy kod GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="220a3-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="220a3-103">Oto kompletny Kod VB.NET, aby uzyskać przykładowe polecenie cmdlet GetProc05.</span><span class="sxs-lookup"><span data-stu-id="220a3-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="220a3-104">Zobacz też</span><span class="sxs-lookup"><span data-stu-id="220a3-104">See Also</span></span>

[<span data-ttu-id="220a3-105">Zestaw SDK programu Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="220a3-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)