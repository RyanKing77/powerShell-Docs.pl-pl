...
---
# <a name="stopprocesssample03-sample"></a>Przykład StopProcessSample03

Ten przykład pokazuje jak napisać polecenia cmdlet, których parametry mają aliasy i której parametry obsługuje znaki symboli wieloznacznych. To polecenie cmdlet jest podobne do `Stop-Process` polecenia cmdlet, dostarczone przez program Windows PowerShell 2.0.

### <a name="how-to-build-the-sample-by-using-visual-studio"></a>Jak skompilować przykład za pomocą programu Visual Studio.

1. Za pomocą Windows PowerShell 2.0 zainstalowany zestaw SDK przejdź do folderu StopProcessSample03. Domyślna lokalizacja to C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample03.
...
- Dodawania aliasów do deklaracji parametrów...

- Włączenie obsługi symboli wieloznacznych do parametrów.

## <a name="example"></a>Przykład

Ten przykład pokazuje sposób deklarowania aliasów parametrów i obsługuje symbole wieloznaczne.
