...
---
# <a name="getprocesssample05-sample"></a>Przykład GetProcessSample05

Niniejszy przykład pokazuje pełną wersję polecenia cmdlet Get-Proc.

## <a name="how-to-build-the-sample-using-visual-studio"></a>Jak skompilować przykład za pomocą programu Visual Studio.

1. Otwórz Eksploratora Windows i przejdź do katalogu GetProcessSample05 w katalogu przykładów.

   Za pomocą Windows PowerShell 2.0 zainstalowany zestaw SDK przejdź do folderu GetProcessSample05. Domyślna lokalizacja to C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\GetProcessSample05.
...
3. W **kompilacji** menu, wybierz opcję **Kompiluj rozwiązanie**.
   ...
   Biblioteka dla przykładu, zostanie utworzona w katalogach \bin lub \bin\debug domyślny.
...
- Określanie pozycje dla parametrów.

- Określenie, czy parametry mogą zajmować danych wejściowych z potoku. Dane wejściowe, może zostać pobrany z obiektem lub wartości z właściwości obiektu, którego nazwa właściwości jest taka sama jak nazwa parametru.

- Deklarowanie atrybut weryfikacji dla parametrów wejściowych.

- Obsługa błędów i wyjątków.

- Zapisywanie komunikatów debugowania.

## <a name="example"></a>Przykład

W tym przykładzie przedstawiono sposób tworzenia polecenia cmdlet, które wyświetla listę określonych procesów.
