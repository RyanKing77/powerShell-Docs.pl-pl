...
---
# <a name="enumeratecollection-element-for-expressionbinding-for-customcontrol-for-view-format"></a>EnumerateCollection, element — ExpressionBinding, CustomControl, View (format)

Określa, czy elementy kolekcji są wyświetlane. Ten element jest używany podczas definiowania widoku formantu niestandardowego.
