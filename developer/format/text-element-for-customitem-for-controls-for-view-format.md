...
---
# <a name="text-element-for-customitem-for-controls-for-view-format"></a>Text, element — CustomItem, Controls, View (format)

Określa tekst, który jest dodawany do danych, który jest wyświetlany przez kontrolkę, takie jak etykiety, nawiasy kwadratowe, należy ująć danych i miejsca do magazynowania, aby wciąć danych. Ten element jest używany podczas definiowania formantów, które mogą być używane przez widok.
