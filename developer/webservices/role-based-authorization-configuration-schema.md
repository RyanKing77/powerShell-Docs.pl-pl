...
---
# <a name="role-based-authorization-configuration-schema"></a>Schemat konfiguracji autoryzacji opartej na rolach

[PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) przykładowe używa plików XML, aby skonfigurować zasady autoryzacji. Następujące XSD definiuje Schemat używany dla tych plików.
