...
---
# <a name="resource-mapping-schema"></a>Schemat mapowania zasobów

Rozszerzenie usług IIS OData zarządzania używa plików XML do definiowania Mapowanie zasobów. Następujące XSD definiuje Schemat używany dla tych plików.

## <a name="resource-mapping-file-xsd"></a>Plik mapowania zasobów XSD

Następujące XSD definiuje schemat dla plików Mapowanie zasobów rozszerzenie usług IIS do zarządzania OData.
