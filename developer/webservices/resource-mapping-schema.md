...
ms.locfileid: "56851499"
---
# <a name="resource-mapping-schema"></a><span data-ttu-id="090e0-102">Schemat mapowania zasobów</span><span class="sxs-lookup"><span data-stu-id="090e0-102">Resource Mapping Schema</span></span>

<span data-ttu-id="090e0-103">Rozszerzenie usług IIS OData zarządzania używa plików XML do definiowania Mapowanie zasobów.</span><span class="sxs-lookup"><span data-stu-id="090e0-103">Management OData IIS Extension uses XML files to define resource mapping.</span></span> <span data-ttu-id="090e0-104">Następujące XSD definiuje Schemat używany dla tych plików.</span><span class="sxs-lookup"><span data-stu-id="090e0-104">The following XSD defines the schema used for these files.</span></span>

## <a name="resource-mapping-file-xsd"></a><span data-ttu-id="090e0-105">Plik mapowania zasobów XSD</span><span class="sxs-lookup"><span data-stu-id="090e0-105">Resource Mapping File XSD</span></span>

<span data-ttu-id="090e0-106">Następujące XSD definiuje schemat dla plików Mapowanie zasobów rozszerzenie usług IIS do zarządzania OData.</span><span class="sxs-lookup"><span data-stu-id="090e0-106">The following XSD defines the schema for Management OData IIS Extension resource mapping files.</span></span>
